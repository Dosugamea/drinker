            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <input required type="number" class="form-control" name="logPrice" min="1" max="100000" placeholder="130" value="130">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input required type="number" class="form-control" id="logCount" name="logCount" min="1" max="1000" placeholder="1" value="1">
                        <div class="input-group-append">
                            <button onclick="changeLogCount(-1)" type="button" class="button btn-primary"> - </button>
                        </div>
                        <script>
